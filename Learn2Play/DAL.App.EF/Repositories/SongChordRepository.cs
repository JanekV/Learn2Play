...
{
    public class SongChordRepository: BaseRepository<SongChord, AppDbContext>, ISongChordRepository
    {
        public SongChordRepository(AppDbContext repositoryDbContext) : base(repositoryDbContext)
        {
        }
